\documentclass[a4paper, twoside]{article}%{IEEE}
...
\begin{document}
	...
	\input{defineGLSL} %define GLSL syntax highlighting
	\input{defineJS} %define JS syntax highlighting 
	\input{defineEZ} %define EZ syntax highlighting
